...
#define STRING_CONFIG_H_AUTHOR "(Rupert Benbrook, personal config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // A10M [@thinkyhead]
    ...
    #define DEFAULT_Kp_LIST {  78.27,  45.80 }
    #define DEFAULT_Ki_LIST {   8.10,   3.61 }
    #define DEFAULT_Kd_LIST { 189.14, 145.39 }
  #else
    #define DEFAULT_Kp 78.27
    #define DEFAULT_Ki 8.10
    #define DEFAULT_Kd 189.14
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 30.46
  #define DEFAULT_bedKi 5.90
  #define DEFAULT_bedKd 104.80
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.83, 80.66, 400.12, 438.06 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.19  // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, 4, -1.85 }
