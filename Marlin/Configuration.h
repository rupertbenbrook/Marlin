...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // A10M [@thinkyhead]
    ...
    #define DEFAULT_Kp_LIST {  33.33,  45.80 }
    #define DEFAULT_Ki_LIST {   1.93,   3.61 }
    #define DEFAULT_Kd_LIST { 144.03, 145.39 }
  #else
    #define DEFAULT_Kp 33.33
    #define DEFAULT_Ki 1.93
    #define DEFAULT_Kd 144.03
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 26.34
  #define DEFAULT_bedKi 4.66
  #define DEFAULT_bedKd 99.27
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.83, 80.66, 400.12, 430 }
